...
goforth.img: forth/goforth.ft forth/asm.ft forth/disasm.ft forth/hw.ft forth/bench.ft out/boot.img dcpu
	...
	cat forth/hw.ft | ./dcpu -k 10000 core.img > /dev/null
	cat forth/bench.ft | ./dcpu -k 10000 core.img > /dev/null
	mv core.img $@
